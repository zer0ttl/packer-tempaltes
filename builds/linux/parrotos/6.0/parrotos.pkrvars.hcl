...
iso_checksum = "file:https://deb.parrot.sh/parrot/iso/6.0/signed-hashes.txt"
iso_urls     = ["https://deb.parrot.sh/parrot/iso/6.0/Parrot-security-6.0_amd64.iso"]
...
vm_guest_os_name               = "parrotos"
vm_guest_server_edition        = "server"
vm_guest_desktop_edition       = "security"
vm_guest_os_version            = "6.0"