...
variable "vm_parrotos_security_edition" {
  type        = string
  description = "The parrotos edition for desktop. Used for naming."
}

variable "vm_parrotos_home_edition" {
  type        = string
  description = "The parrotos edition for home. Used for naming."
}
